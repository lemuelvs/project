...
//   const [eventName, setEventName] = useState('');
  ...
  const [events, setEvents] = useState([
    // Sample event data
    { id: 1, name: 'HighQ Academy', themeCost: '', rating: 'Chennai', description: '' },
    { id: 1, name: 'Narayanan Chess Academy ', themeCost: '', rating: 'Coimbatore', description: '' },
    { id: 1, name: ' Vaishadha School ', themeCost: '', rating: 'Madurai', description: '' },
    { id: 1, name: ' Master Chess Academy', themeCost: '', rating: 'Theni', description: '' },
    { id: 1, name: 'Best Academy', themeCost: '', rating: 'Trichy', description: '' },
