...
//   const [eventName, setEventName] = useState('');
  ...
  const [events, setEvents] = useState([
    // Sample event data
    { id: 1, name: 'Narayanan chess center', themeCost: '', rating: 'Chennai', description: '' },
    { id: 1, name: 'Vasishta Sports academy', themeCost: '', rating: 'Coimbatore', description: '' },
    { id: 1, name: 'HighQ Academy', themeCost: '', rating: 'Madurai', description: '' },
    { id: 1, name: 'RK chess center', themeCost: '', rating: 'Theni', description: '' },
    { id: 1, name: 'ChessMate academy', themeCost: '', rating: 'nellai', description: '' },
